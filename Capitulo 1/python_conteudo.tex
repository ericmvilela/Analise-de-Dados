...
\title{Data Analysis with Python 2024--2025\\Parte 1: Python\\\large Conteúdo Teórico}
...
Esta parte apresenta os fundamentos de Python usados no restante do curso. Os objetivos são aprender os conceitos básicos da linguagem, compreender strings e módulos, e trabalhar com sequências e objetos iteráveis. 
